...
namespace AgendaServicios.Web.Controllers
{
	public class LocalidadesController : Controller
	{
		...
		{
			var localidades = _context.Localidades.Include(l => l.Provincia);
		...
		public async Task<IActionResult> Create([Bind("LocalidadId,Descripcion,ProvinciaId")] Localidad localidad)
		{
			...
			ViewData["SelectListProvincia"] = new SelectList(_context.Provincias, "ProvinciaId", "Descripcion", localidad.ProvinciaId);
